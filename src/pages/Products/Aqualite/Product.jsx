      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <div className="space-y-4 text-gray-600 text-base md:text-md leading-relaxed">
              <p>
                Amid the <span className="text-gray-900 font-medium">hustle of urban life</span>, we create a quiet, comfortable, and healthy private space for you.
              </p>
              
              <p>
                Aqualite offers <span className="text-gray-900 font-medium">complete relaxation</span> every time you use it. Designed to bring the tranquility of the forest into your home, ensuring a seamless harmony between modern living and the natural world.
              </p>
            </div>
