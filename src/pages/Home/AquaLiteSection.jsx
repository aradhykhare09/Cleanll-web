        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-gray-500 text-base md:text-md leading-relaxed text-justify">
              ...
              brings the organic feel of the forest into your modern bathroom. With features like quiet comfort, fresh breeze drying, and an organic aesthetic, it creates a private sanctuary that feels less like a utility and more like a retreat.
            </p>
