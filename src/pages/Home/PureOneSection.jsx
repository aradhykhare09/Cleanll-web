          ...
          >
            ...
            <div>
              ...
              <h2 className="text-4xl md:text-6xl font-serif text-gray-900 leading-none">
                PureOne <span className="text-transparent bg-clip-text bg-linear-to-r from-gray-800 to-gray-500">Manual Bidet</span>
              </h2>
            </div>
            ...
            <p className="text-gray-500 text-lg leading-relaxed text-justify">
              ...
              This innovative tankless toilet features a unique 
              <span className="italic"> Knob Operation</span> system, allowing for precise control over 
              hip and feminine wash without the need for complex electronics.
            </p>
            <p className="text-gray-500 text-lg leading-relaxed text-justify">
              Equipped with a non-electric washing platform that uses tap water pressure, 
              PureOne delivers a powerful, eco-friendly clean. Combined with off-seat auto flushing 
              and a soft-close seat, it defines the new standard for manual bidet toilets.
            </p>
