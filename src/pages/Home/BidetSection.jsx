...
const BidetSection = () => {
  return (
    <section className="py-12 bg-white overflow-hidden font-poppins mb-18">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-gray-500 text-base md:text-md leading-relaxed text-justify">
              ...
              Featuring a <span className="italic">Dual Nozzle</span> system, it provides a gentle, controlled water stream for ultimate cleaning without requiring any electricity. Designed for water efficiency and consistency, it offers adjustable pressure and minimal hand contact, reducing contamination risk while ensuring a healthy, comfortable, and hygienic lifestyle.
            </p>
